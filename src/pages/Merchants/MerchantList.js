...
const MerchantList = () => {
    ...
    const filteredMerchant = merchantList.filter(
        (merchant) =>
            merchant.firstName.toLowerCase().includes(searchQuery.trim()) // Adjust this to match your product's name or any other property
    );
